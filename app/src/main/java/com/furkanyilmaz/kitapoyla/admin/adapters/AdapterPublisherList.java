...
public class AdapterPublisherList extends BaseAdapter {
    ...
    public AdapterPublisherList(List<Publisher> listPublisher, Context context) {
        this.listPublisher = listPublisher;
        this.context = context;
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        firebaseDatabase = FirebaseDatabase.getInstance().getReference().child("PublisherList");
    }
    ...
    public Publisher getItem(int position) {
        return listPublisher.get(position);
    }
